...
ExprResult Parser::ParseBuiltinObjectRepresentationPointer() {
  SourceLocation KWLoc = ConsumeToken();
  ...
  return Actions.ActOnBuiltinObjectRepresentationPointerExpr(
      KWLoc, DeclaratorInfo, Operand, T.getCloseLocation());
}
